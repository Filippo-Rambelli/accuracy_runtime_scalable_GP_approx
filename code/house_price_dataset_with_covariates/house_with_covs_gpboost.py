...
#gpboost_run_with_covs(gp_approx="vecchia",num_neighbors=10)
#gpboost_run_with_covs(gp_approx="vecchia",num_neighbors=20)
#gpboost_run_with_covs(gp_approx="vecchia",num_neighbors=40)
#gpboost_run_with_covs(gp_approx="vecchia",num_neighbors=80)

gpboost_run_with_covs(gp_approx="tapering",cov_fct_taper_range=265/10000)
gpboost_run_with_covs(gp_approx="tapering",cov_fct_taper_range=520/10000)
gpboost_run_with_covs(gp_approx="tapering",cov_fct_taper_range=790/10000)
gpboost_run_with_covs(gp_approx="tapering",cov_fct_taper_range=1396/10000)
gpboost_run_with_covs(gp_approx="tapering",cov_fct_taper_range=1745/10000)

gpboost_run_with_covs(gp_approx="fitc",num_ind_points=220)
gpboost_run_with_covs(gp_approx="fitc",num_ind_points=500)
gpboost_run_with_covs(gp_approx="fitc",num_ind_points=1000)
gpboost_run_with_covs(gp_approx="fitc",num_ind_points=2200)
gpboost_run_with_covs(gp_approx="fitc",num_ind_points=3700)

gpboost_run_with_covs(gp_approx="full_scale_tapering",num_ind_points=106,cov_fct_taper_range=183/10000)
gpboost_run_with_covs(gp_approx="full_scale_tapering",num_ind_points=252,cov_fct_taper_range=285/10000)
gpboost_run_with_covs(gp_approx="full_scale_tapering",num_ind_points=444,cov_fct_taper_range=423/10000)
gpboost_run_with_covs(gp_approx="full_scale_tapering",num_ind_points=1050,cov_fct_taper_range=917/10000)
gpboost_run_with_covs(gp_approx="full_scale_tapering",num_ind_points=1900,cov_fct_taper_range=1150/10000)
