...
exact_pred_mean_train= np.loadtxt("exact_results/exact_pred_mean_train_house.txt")
exact_pred_var_train = np.loadtxt("exact_results/exact_pred_var_train_house.txt")
exact_pred_mean_inter = np.loadtxt("exact_results/exact_pred_mean_inter_house.txt")
exact_pred_var_inter = np.loadtxt("exact_results/exact_pred_var_inter_house.txt")
exact_pred_mean_extra = np.loadtxt("exact_results/exact_pred_mean_extra_house.txt")
exact_pred_var_extra = np.loadtxt("exact_results/exact_pred_var_extra_house.txt")
...
def gpboost_run(gp_approx, **kwargs):
    ...
    filename_save = f"results/house/{base_name}_house_{param_str}".replace("__", "_")
...
gpboost_run(gp_approx="vecchia",num_neighbors=5)
gpboost_run(gp_approx="vecchia",num_neighbors=10)
gpboost_run(gp_approx="vecchia",num_neighbors=20)
gpboost_run(gp_approx="vecchia",num_neighbors=40)
gpboost_run(gp_approx="vecchia",num_neighbors=80)

gpboost_run(gp_approx="tapering",cov_fct_taper_range=265)
gpboost_run(gp_approx="tapering",cov_fct_taper_range=520)
gpboost_run(gp_approx="tapering",cov_fct_taper_range=790)
gpboost_run(gp_approx="tapering",cov_fct_taper_range=1396)
gpboost_run(gp_approx="tapering",cov_fct_taper_range=1745)

gpboost_run(gp_approx="fitc",num_ind_points=220)
gpboost_run(gp_approx="fitc",num_ind_points=500)
gpboost_run(gp_approx="fitc",num_ind_points=1000)
gpboost_run(gp_approx="fitc",num_ind_points=2200)
gpboost_run(gp_approx="fitc",num_ind_points=3700)

gpboost_run(gp_approx="full_scale_tapering",num_ind_points=106,cov_fct_taper_range=183)
gpboost_run(gp_approx="full_scale_tapering",num_ind_points=252,cov_fct_taper_range=285)
gpboost_run(gp_approx="full_scale_tapering",num_ind_points=444,cov_fct_taper_range=423)
gpboost_run(gp_approx="full_scale_tapering",num_ind_points=1050,cov_fct_taper_range=917)
gpboost_run(gp_approx="full_scale_tapering",num_ind_points=1900,cov_fct_taper_range=1150)
